...
export default function Hero({ onOpenSample }) {
  ...
  useEffect(() => {
    ...
    let target = new Date(`November 29, ${targetYear} 08:30:00 GMT+0530`);
    if (now > target) {
      target = new Date(`November 29, ${targetYear + 1} 08:30:00 GMT+0530`);
    }
    ...
    >
      ...
      <div className="max-w-[1240px] mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 text-left">
          {/* Top Row Badges: Label + Live Urgency Countdown */}
          <div className="flex flex-wrap items-center gap-3 mb-4">
            <div className="inline-flex items-center gap-2 bg-[#f38e3e]/12 border border-[#f38e3e]/30 text-[#ffd4a8] px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider backdrop-blur-sm">
              <i className="fa-solid fa-bolt text-[#f38e3e] text-xs"></i>
              <span>{productData.badge}</span>
            </div>

            {/* Live Exam Countdown Urgency Pill */}
            <div className="inline-flex items-center gap-2.5 bg-white/5 border border-white/15 px-3 py-1 rounded-full text-xs font-medium text-white/90 backdrop-blur-md">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#f38e3e] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#f38e3e]"></span>
              </span>
              <span className="text-[11px] font-bold text-[#b4d0d1] uppercase tracking-wide">Exam Countdown:</span>
              <div className="flex items-center gap-1 font-mono font-bold text-xs text-[#ffd4a8]">
                ...
                <span className="text-white/40">:</span>
                <span className="text-[#f38e3e]">{timeLeft.seconds}s</span>
              </div>
            </div>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-bold text-white tracking-tight leading-[1.12] mb-3">
            CAT Quantitative Ability & VARC <span className="text-[#f38e3e] italic font-normal">Guess Paper</span> 2027
          </h1>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-5 mb-7 backdrop-blur-md max-w-[580px]">
            ...
            <p className="text-xs sm:text-sm text-white/80 font-medium flex items-center gap-2">
              ...
              <span>Quantitative Ability & VARC • Digital PDF • Exam-Focused</span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 pt-3 border-t border-white/10 max-w-[580px] text-xs font-semibold text-white/85">
            ...
            <div className="relative bg-gradient-to-b from-[#112629] to-[#0c1c1e] border-2 border-white/15 rounded-2xl p-6 sm:p-7 shadow-[0_25px_60px_rgba(0,0,0,0.6)] text-left overflow-hidden">
              ...
              <div className="bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-xl p-5 mb-5 relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 text-[11px] font-bold text-[#b4d0d1] bg-black/30 px-2.5 py-1.5 rounded-md border border-white/5">
                  ...
                  <span>QUANTITATIVE ABILITY • VARC</span>
                </div>
              </div>
              ...
              <div className="space-y-2 mb-5 text-xs text-white/75">
                <div className="flex items-center justify-between bg-white/[0.03] p-2 rounded-lg border border-white/5">
                  <span className="flex items-center gap-2">
                    <i className="fa-solid fa-calculator text-[#468e91]"></i> Quantitative Ability Practice
                  </span>
                  <span className="text-[11px] font-bold text-[#7bdcb5]">✓ Included</span>
                </div>
                <div className="flex items-center justify-between bg-white/[0.03] p-2 rounded-lg border border-white/5">
                  <span className="flex items-center gap-2">
                    <i className="fa-solid fa-book-open-reader text-[#f38e3e]"></i> VARC Critical & RC Practice
                  </span>
                  <span className="text-[11px] font-bold text-[#7bdcb5]">✓ Included</span>
                </div>
                <div className="flex items-center justify-between bg-white/[0.03] p-2 rounded-lg border border-white/5">
                  <span className="flex items-center gap-2">
                    <i className="fa-solid fa-arrow-up-right-dots text-[#b4d0d1]"></i> Topic Prioritization Blueprint
                  </span>
                  <span className="text-[11px] font-bold text-[#7bdcb5]">✓ Included</span>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-white/10 flex items-center justify-between">
                <div>
                  ...
                  <span className="text-xs font-bold text-white flex items-center gap-1.5">
                    <i className="fa-solid fa-file-pdf text-red-400"></i> Digital PDF
                  </span>
                </div>

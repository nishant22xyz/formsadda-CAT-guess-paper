      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="section-label justify-center">
            <i className="fa-solid fa-comments"></i> Aspirant Feedback
          </div>
          <h2 className="section-title">What CAT Aspirants Say</h2>
          <p className="section-sub max-w-2xl mx-auto">
            Honest reflections from aspirants who utilized FormsADDA's exam preparation materials to streamline their revision phase.
          </p>
        </div>

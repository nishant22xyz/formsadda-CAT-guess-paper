      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="section-sub max-w-2xl mx-auto">
            Everything you need for focused, high-priority CAT revision packed into a single searchable digital PDF.
          </p>
        </div>
          ...
          <div className="p-7 sm:p-9">
            ...
            <div className="border-b border-[#dde4e6] pb-6 mb-7">
              <span className="text-xs font-bold text-[#008190] uppercase tracking-wider block mb-1">
                {productData.exam} • {productData.session}
              </span>

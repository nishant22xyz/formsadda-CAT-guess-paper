      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="section-sub max-w-2xl mx-auto">
            CAT preparation involves a vast range of concepts across Quantitative Ability and VARC. This resource is designed to help aspirants focus on high-priority preparation areas for structured revision.
          </p>
        </div>
        ...
        <div className="mt-12 bg-[#e6f0f1] border border-[#b4d0d1] rounded-xl p-4 sm:p-5 max-w-3xl mx-auto flex items-start gap-3.5 text-left">
          ...
          <p className="text-xs sm:text-sm text-[#2e4447] leading-relaxed m-0 font-medium">
            <strong className="text-[#008190] font-bold">Academic Transparency:</strong> A guess paper organizes high-priority concepts and practice question formulations for Quantitative Ability and VARC. It is designed as additional revision and practice material.
          </p>
        </div>
      </div>
    </section>

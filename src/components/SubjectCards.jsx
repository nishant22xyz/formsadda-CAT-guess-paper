      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="section-label justify-center">
            <i className="fa-solid fa-layer-group"></i> Dedicated 2-Section Package
          </div>
          <h2 className="section-title">Two Core Sections. One Comprehensive Package.</h2>
          <p className="section-sub max-w-2xl mx-auto">
            Get structured, topic-wise high-priority question sets and concept frameworks for Quantitative Ability and VARC in a single convenient document.
          </p>
        </div>

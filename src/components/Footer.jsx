      ...
      <div className="max-w-[1240px] mx-auto text-left">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50">
          <p className="m-0 text-center md:text-left max-w-2xl leading-relaxed">
            <strong className="text-white/70">Educational Disclaimer:</strong> This is an independent CAT preparation resource created by FormsADDA. It is not an official CAT question paper and is not affiliated with or endorsed by IIMs. No guarantee is made that any particular question will appear in CAT 2027.
          </p>
          <div className="text-center md:text-right whitespace-nowrap">
            © 2027 FormsADDA. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
